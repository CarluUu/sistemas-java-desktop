...
public class ViewConsultaProduto extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewConsultaProduto().setVisible(true);
            }
        });
    }
    ...
    var modelo = (DefaultTableModel) tabelaDados.getModel();
        
         // Reseta registros da tabela
        modelo.setRowCount(0);

        // Lista todas as pessoas da classe pessoadb
        ArrayList<model.ModelProduto> produto = produtodb.getTodos();
